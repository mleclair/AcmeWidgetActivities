...
namespace AcmeWidget.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
			ActivityContext activityDb = new ActivityContext ( );

			ViewBag.ActivitiesSelectList = new SelectList ( activityDb.Activities.ToList ( ) , "Id" , "ActivityType" );

			if ( ModelState.IsValid )
            {
                //var user = new UserProfile { UserName = model.PersonalEmail , Email = model.PersonalEmail };
        ...
        public ActionResult AddUser(UserProfile userProfile)
        {
			...
			ViewBag.dropdownVD = new SelectList ( activityDb.Activities.ToList ( ) , "Id" , "ActivityType" );
